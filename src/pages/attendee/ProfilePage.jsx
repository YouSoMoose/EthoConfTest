...
export default function ProfilePage() {
  ...
  async function saveResume() {
    setSaving(true)
    await sb.from('profiles').update({ resume_url: resumeUrl }).eq('id', profile.id)
      ...
      <div className="content">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 0 24px', gap: 10 }}>
          <div style={{
            ...
            fontSize: 26, fontWeight: 700, fontFamily: 'var(--fh)', color: '#fff',
            overflow: 'hidden',
          }}>
            {profile?.avatar_url
        ...
        <div style={{ fontSize: 12, color: 'var(--sub)', marginBottom: 12, lineHeight: 1.6 }}>
          Add a public link to your resume or portfolio. It will be included in your profile QR code so others can scan and view your work.
        </div>
        ...
        <button className="btn btn-accent btn-full" onClick={saveResume} disabled={saving}>
          ...
          <>
            ...
            <div className="card">
              <div style={{ fontSize: 13, color: 'var(--sub)', lineHeight: 1.5 }}>
                Access Level {level} — Presenter features unlocked. You can add and manage your own company in the Pitches section. Contact your event coordinator to update company details.
              </div>
            </div>
          </>
        )}
